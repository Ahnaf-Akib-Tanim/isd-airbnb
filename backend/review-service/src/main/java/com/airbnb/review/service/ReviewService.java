    ...
    private void updateHostRating(String hostId) {
        ...
        try {
            String url = String.format(
                "%s/api/users/host/%s/rating?averageRating=%.2f&reviewCount=%d&cleanlinessRating=%.2f&accuracyRating=%.2f&checkInRating=%.2f&communicationRating=%.2f&locationRating=%.2f&valueRating=%.2f",
                userServiceUrl, hostId, avg, count, avgClean, avgAcc, avgCheck, avgComm, avgLoc, avgVal
            );
