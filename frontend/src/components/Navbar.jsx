...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''} ${isHomePage ? 'navbar--home' : ''}`}>
      <div className="navbar__container">
        ...
        {isHomePage && (
          <div className="navbar__search">
            <button className="navbar__search-bar">
              ...
              <span className="navbar__search-divider" />
              <span className="navbar__search-item navbar__search-item--gray">Add guests</span>
        ...
        <div className="navbar__actions">
          ...
          <button className="navbar__icon-btn" aria-label="Language">
            <svg viewBox="0 0 16 16" aria-hidden="true" focusable="false" style={{ width: 16, height: 16 }}>
              <path
                  ...
                  <>
                    <div className="navbar__dropdown-header">
                      ...
                      <div>
                        ...
                        <span className={`badge ${user?.role === 'HOST' ? 'badge-red' : 'badge-gray'}`}>
                          {user?.role}
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      <svg viewBox="0 0 32 32" aria-hidden="true">
                        <path d="M16 2a14 14 0 1 0 0 28A14 14 0 0 0 16 2zm0 5a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9zm0 19a10.5 10.5 0 0 1-8-3.7 6 6 0 0 1 5.33-3.3h5.34A6 6 0 0 1 24 22.3 10.5 10.5 0 0 1 16 26z" fill="currentColor"/>
                      </svg>
                      Profile
                    </button>
                    ...
                    {user?.role === 'HOST' && (
                      ...
                      >
                        <svg viewBox="0 0 32 32" aria-hidden="true">
                          <path d="M27 18H5v13h22V18zM16 3L1 16h4v15h22V16h4L16 3z" fill="currentColor"/>
                        </svg>
                        My Listings
                      </button>
                    )}
                    ...
                    >
                      <svg viewBox="0 0 32 32" aria-hidden="true">
                        <path d="M26 2H6a2 2 0 0 0-2 2v24a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zm-1 25H7V5h18v22zM11 11h10v2H11zm0 5h10v2H11zm0 5h6v2h-6z" fill="currentColor"/>
                      </svg>
                      My Bookings
                    </button>
                    ...
                    >
                      <svg viewBox="0 0 32 32" aria-hidden="true">
                        <path d="M6 30h14v-2H8V4h12V2H6v28zm20.83-15l-4.16-4.17-1.42 1.42L23.59 15H14v2h9.59l-2.34 2.34 1.42 1.42 4.16-4.17A1 1 0 0 0 26.83 15z" fill="currentColor"/>
                      </svg>
                      Log out
                    </button>
                  </>
